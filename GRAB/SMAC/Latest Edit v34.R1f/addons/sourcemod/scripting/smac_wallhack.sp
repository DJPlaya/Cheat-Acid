...
public OnPluginStart()
{
	...
	hCvar = SMAC_CreateConVar("smac_wallhack", "1", "Enable Anti-Wallhack. This will increase your server's CPU usage.", _, true, 0.0, true, 1.0);
...
Wallhack_UpdateClientCache(client)
{
	...
	g_bIgnore[client] = g_bForceIgnore[client] || g_bIsFake[client];
}
